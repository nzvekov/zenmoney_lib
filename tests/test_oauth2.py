...
class TestZenmoneyOAuth2:
    ...
    def oauth_client(self):
        return ZenmoneyOAuth2(
            consumer_key="test_key", consumer_secret="test_secret", username="test_user", password="test_pass"
        )
    ...
    def test_get_token_success(self, oauth_client):
        ...
        with (
            patch.object(oauth_client, "_get_code", return_value="test_code"),
    ...
    def test_get_code_success(self, oauth_client):
        ...
        mock_auth_response.headers = {"Location": "https://example.com/callback?code=test_code"}

        with patch.object(oauth_client, "_get"), patch.object(oauth_client, "_post", return_value=mock_auth_response):
